...
(define-abbrev-table 'e2wm:def-plugin-bookmarks-list-mode-abbrev-table '())
...
(define-abbrev-table 'html-mode-abbrev-table
  '(
    ("addr" "" insert-hcard 0)
    ("html" "" insert-html-skeleton 0)
    ("html4" "" insert-doctype-html4 0)
    ("html4fr" "" insert-doctype-html4fr 0)
    ("html4st" "" insert-doctype-html4st 0)
    ("style" "" insert-default-css 0)
    ("utf8" "" insert-utf8-declaration 0)
   ))
...
(define-abbrev-table 'javap-mode-abbrev-table '())

(define-abbrev-table 'js-mode-abbrev-table '())

(define-abbrev-table 'jst-run-spec-mode-abbrev-table '())
...
(define-abbrev-table 'pydoc-mode-abbrev-table '())
...
(define-abbrev-table 'vc-p4-log-view-mode-abbrev-table '())

(define-abbrev-table 'vc-svn-log-view-mode-abbrev-table '())

(define-abbrev-table 'wikipedia-mode-abbrev-table '())

(define-abbrev-table 'wsd-mode-abbrev-table '())
